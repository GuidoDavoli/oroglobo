...
path_data_in_mask=cfg['paths_in']["model_masks"].replace("*GRIDNAME*", gridname) 
...
netcdf_model_grid_orog_in=cfg['files_work']["netcdf_model_grid_orog"].replace("*GRIDNAME*", gridname) 
netcdf_model_mask_in=cfg['files_in']["netcdf_model_mask"].replace("*GRIDNAME*", gridname) 
netcdf_model_mask_lake_in=cfg['files_in']["netcdf_model_mask_lake"].replace("*GRIDNAME*", gridname) 
netcdf_model_grid_operational_orog_out=cfg['files_out']["netcdf_model_grid_operational_orog"].replace("*GRIDNAME*", gridname) 
img_model_grid_operational_orog_out=cfg['files_out']["img_model_grid_operational_orog"].replace("*GRIDNAME*", gridname) 

d=int(cfg['filtering_Ndx_ecmwf']["d"])
