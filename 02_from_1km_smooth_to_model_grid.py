...
netcdf_model_grid_orog_out=oropar.files_work["netcdf_model_grid_orog"].replace("*GRIDNAME*", gridname) 
netcdf_1km_smooth_orog_in=oropar.files_work["netcdf_1km_smooth_orog"].replace("*GRIDNAME*", gridname) 
...
## plotting
oroplot.orography_plot(mean_orog_on_model_grid,path_img_out+img_model_grid_orog_out,600)
